...
const FlightsCheckoutDetailSecond = () => {
  return (

      //FlightsCheckoutDetail

<div className='FlightsCheckoutDetailSecond'>     
<Hidden only={['lg','xl']}>
    <Grid className='purchaseDetailSecond' item xs={12}>
        <Box border={2} className='purchaseDetailItemSecond'>
        ...
        <Box border={2} className='purchaseDetailItemSecond'>
                    <label className='resultSecond'>TOTAL</label>
                    <label className='result1Second'>$935.540</label>
        </Box>
    </Grid>     
    <Grid className='descriptionCashSecond' item xs={12}>
        <Box>
    ...
    <div className='payDetailSecond'  >
          <div className='payDetailLocationHeaderSecond'>
                <div className='payDetailLocationHeaderTitleSecond' >
          ...
          <div className='payDetailModifySecond' >
                <div className='line' style={{ width: '100%', height: '1.5px', backgroundColor: 'rgba(0, 66, 116, .2)', margin: '30px 0', borderRadius: '20px' }} />
                <div>
                        <p>5 noches, 2 adultos 1 menor</p>
                        <p>Habitacion Cuadruple Estandar</p>
                        <h3 className='breakfastSecond'> desayuno americano</h3>
                </div>
                <div className='payDetailConditionSecond'>
                    ...
                    <h3 className='conditionSecond'>Ver condiciones</h3>
                </div>
        </div>
    </div>
</Hidden>
...
export default FlightsCheckoutDetailSecond